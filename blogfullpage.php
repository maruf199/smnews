  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-8">
        ...
        <!-- Title -->
        <h1 class="mt-4" style="text-align:left;"><?php echo $row['title_name']?></h1>

        <!-- Author -->
        <p>
          <b>Catagory:</b><?php echo $row['catagory'] ?>
        </p>

        <p><b>প্রকাশের তারিখ ও সময়:</b> <?php echo $row['date']?> & <?php echo $row['time'] ?></p>

        <!-- Preview Image -->
        <img src="<?php echo $row['img']?>" alt="" class="responsive">

        <hr>

        <!-- Post Content -->
        <p><?php echo $row['title_explanation'] ?></p>
