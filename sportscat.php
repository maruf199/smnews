  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-8">
        ...
        <h4 class="my-4">ক্যাটাগরিঃখেলাধুলা
        </h4>

        <!-- Blog Post -->

      <?php 
      $sql="select * from blog where catagory='খেলাধুলা' order by id desc limit $record_index, $limit";
...
echo"<ul class='pagination justify-content-center'>";
  echo "<li><a href='sportscat.php?page=".($page-1)."' class='button'>PREVIOUS</a></li>"; 
    echo "<li><a href='sportscat.php?page=".($page+1)."' class='button'>NEXT</a></li>";
