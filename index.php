...
<body>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <?php 
      $sql="select * from blog order by id desc limit $record_index, $limit";
      ...
      if($result){
        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            ...
            <a href="blogfullpage.php?id=<?php echo $row['id']?>"class="btn btn-danger">বিস্তারিত পড়ুন</a>
  ...
  প্রকাশের তারিখ ও সময়:<?php echo $row['date'] ?> <?php echo $row['time']?>
     ...
     <?php 
      ...
      <div class="card my-4">
        <h3 style="text-align:center"><b>এইমাত্র পাওয়া খবর</b></h3>
        <div class="new_post">
         <?php 
      ...
      if($result){
        ...
        <img src="img/new_post icon.png" width="40px" heigh="40px"><a href="blogfullpage.php?id=<?php echo $row['id']?>"><?php echo $row['title_name'] ?></a><br><br>
